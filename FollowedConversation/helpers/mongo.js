...
exports.mongo_insert = function (collection, data) {
    return new Promise(function (resolve, reject) {
        ...
        var tracking_events_mongo = new Schema(config.followedConversationSchema);

        tracking_events_mongo.index({teamEmail:1,conversationId:1,userEmail:1} , {unique:true});
...
exports.mongo_find = function (collection,filter = {}) {
    return new Promise(function (resolve, reject) {
        var Schema = mongoose_client.Schema;
	var tracking_events_mongo = new Schema(config.followedConversationSchema, {strict : false});
